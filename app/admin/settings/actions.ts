...
export async function updateToggleSetting(key: string, value: boolean) {
    ...
    // Validate key
    const allowedKeys = ['messaging_enabled', 'voting_enabled', 'registration_enabled', 'announcement_enabled', 'gallery_enabled'];
    ...
    const descriptions: Record<string, string> = {
        ...
        gallery_enabled: 'Fotoğraf galerisi açık/kapalı'
    };

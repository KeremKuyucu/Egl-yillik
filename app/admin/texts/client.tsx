...
interface AdminTextsClientProps {
    initialTexts: Text[]
    initialAnonymousTexts: AnonymousText[]
    canReadContent: boolean
}

export default function AdminTextsClient({ initialTexts, initialAnonymousTexts, canReadContent }: AdminTextsClientProps) {
    const router = useRouter()
    const [isPending, startTransition] = useTransition()

    const [texts, setTexts] = useState<Text[]>(initialTexts)
    const [anonymousTexts, setAnonymousTexts] = useState<AnonymousText[]>(initialAnonymousTexts)
    ...
    useEffect(() => {
        ...
        setAnonymousTexts(initialAnonymousTexts)
    }, [initialTexts, initialAnonymousTexts])

        ...
        <div className="flex min-h-screen w-full items-center justify-center bg-slate-50/50 p-6 md:p-10 relative overflow-hidden">
            ...
            <div className="w-full max-w-[400px] animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="flex flex-col items-center gap-4 mb-8 text-center">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-serif text-slate-900 tracking-tight">Yeni Şifre Belirle</h1>
                        <p className="text-sm text-slate-500 font-medium">Hesabınız için güçlü bir şifre seçin</p>
                    </div>
                </div>
                    ...
                    {success ? (
                        ...
                        <>
                            <CardHeader className="text-center pb-6 border-b border-slate-100">
                                <CardTitle className="text-lg font-bold text-slate-800">Şifre Yenileme</CardTitle>
                                <CardDescription>Lütfen yeni şifrenizi giriniz.</CardDescription>
                            </CardHeader>
